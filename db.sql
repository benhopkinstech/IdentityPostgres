...
(
    ...
    CONSTRAINT pk_account_verification PRIMARY KEY (id),
    CONSTRAINT fk_account_verification_account FOREIGN KEY (account_id)
        REFERENCES identity.account (id)
);

ALTER TABLE IF EXISTS identity.account_verification
    OWNER to postgres;
--------------------------------------------------
